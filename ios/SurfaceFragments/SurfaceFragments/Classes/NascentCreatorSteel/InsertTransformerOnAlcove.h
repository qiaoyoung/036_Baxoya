...
//: @interface InsertTransformerOnAlcove : NSObject
@interface InsertTransformerOnAlcove : NSObject
/**
 *  生成二维码图片
 *
...
+(NSString *)low:(UIImage *)image;

//: +(UIImage *)createQRimageString:(NSString *)QRString sizeWidth:(CGFloat)sizeWidth fillColor:(UIColor *)color;
+(UIImage *)insertOf:(NSString *)QRString mission:(CGFloat)sizeWidth invite:(UIColor *)color;
//: @end
@end