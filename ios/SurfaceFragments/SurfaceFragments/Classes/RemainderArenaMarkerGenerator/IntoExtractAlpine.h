...
//: @interface IntoExtractAlpine : NSObject
@interface IntoExtractAlpine : NSObject

//联系人姓名
//: @property(nonatomic, readonly) NSDictionary *contentDic;
@property(nonatomic, readonly) NSDictionary *faint;

//联系人title
//: @property(nonatomic, readonly) NSArray *sectionTitles;
@property(nonatomic, readonly) NSArray *muse;
//: @property(nonatomic, strong) NSArray *specialMembers;
@property(nonatomic, strong) NSArray *random;
//: @property(nonatomic, strong) NSArray *members;
@property(nonatomic, strong) NSArray *clear;
