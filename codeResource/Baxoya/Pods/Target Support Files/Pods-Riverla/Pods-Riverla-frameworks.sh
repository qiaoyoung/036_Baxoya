...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/SurfaceFragments/NIMSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/SurfaceFragments/NIMNOS.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/SurfaceFragments/NIMQuic.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/SurfaceFragments/NIMSocketRocket.framework"
fi
