...
//: @implementation NSDictionary (RunBonnyJourneyTweak)
@implementation NSDictionary (RunBonnyJourneyTweak)

//: - (NSString *)nimkit_jsonString: (NSString *)key
- (NSString *)treasure: (NSString *)key
{
...
- (BOOL)runningCandid: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (NSDictionary *)towardWarm: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
...
- (NSArray *)destination: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
...
- (NSArray *)curve: (NSString *)key
{
    //: NSArray *array = [self nimkit_jsonArray:key];
    NSArray *array = [self destination:key];
    //: BOOL invalid = NO;
    BOOL invalid = NO;
...
- (unsigned long long)stand:(NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (long long)reliable: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
