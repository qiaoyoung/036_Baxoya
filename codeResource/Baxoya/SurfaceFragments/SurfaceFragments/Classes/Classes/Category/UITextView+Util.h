...
@property (nonatomic, copy) textViewHeightDidChangedBlock unusual;
/* 占位文字颜色 */
//: @property (nonatomic, strong) UIColor *placeholderColor;
@property (nonatomic, strong) UIColor *strokeCollector;
/* 最大高度，如果需要随文字改变高度的时候使用 */
//: @property (nonatomic, assign) CGFloat maxHeight;
@property (nonatomic, assign) CGFloat enter;
/* 最小高度，如果需要随文字改变高度的时候使用 */
//: @property (nonatomic, assign) CGFloat minHeight;
@property (nonatomic, assign) CGFloat identify;
/* 获取图片数组 */
//: - (NSArray *)getImages;
...
- (void)signature:(CGFloat)maxHeight reason:(textViewHeightDidChangedBlock)textViewHeightDidChanged;
