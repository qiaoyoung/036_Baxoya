...
// __CLOSE_PRINT__
//
//  UIActionSheet+TailGiftedDigitalRobust.m
//  eim_iphone
//
...
static char k_transformReferString;


//: @implementation UIActionSheet (TailGiftedDigitalRobust)
@implementation UIActionSheet (TailGiftedDigitalRobust)
...
- (void)actionSheet:(UIActionSheet *)actionSheet didDismissWithButtonIndex:(NSInteger)buttonIndex
{
    ...
    ActionSheetBlock block = [objc_getAssociatedObject(self, &k_transformReferString) copy];
    //: objc_setAssociatedObject(self,&kUIActionSheetBlockAddress,nil,OBJC_ASSOCIATION_COPY);
    objc_setAssociatedObject(self,&k_transformReferString,nil,OBJC_ASSOCIATION_COPY);
...
- (void)saveWinter: (UIView *)view hold: (ActionSheetBlock)block
{
    ...
    objc_setAssociatedObject(self,&k_transformReferString,block,OBJC_ASSOCIATION_COPY);
    ...
    else
    {
        ...
        else
        {
            ...
            [self performSelector:@selector(numbers:)
                       //: withObject:view
                       withObject:view
                       //: afterDelay:1];
                       afterDelay:1];
