...
{
    return [GraveYieldLandClassify filepathForDir:RDVideo
                                     filename:filename];
}

+ (NSString *)filepathForImage:(NSString *)filename
{
    return [GraveYieldLandClassify filepathForDir:RDImage
                                     filename:filename];
}

+ (NSString *)filepathForMergeForwardFile:(NSString *)filename {
    return [GraveYieldLandClassify filepathForDir:RDMerge
                                     filename:filename];
}
