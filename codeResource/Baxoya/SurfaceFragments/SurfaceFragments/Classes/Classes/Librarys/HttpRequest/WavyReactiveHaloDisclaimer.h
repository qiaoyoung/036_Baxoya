...
extern __attribute__((visibility ("default"))) NSString *const themeMethodFailureName(NSString *value);/** Touken前缀*/

extern __attribute__((visibility ("default"))) NSString *const themeMapTranslateName(NSString *value);/** 加密密钥*/

extern __attribute__((visibility ("default"))) NSString *const appStatusNumber(NSString *value);/** 即时聊天*/
