...
@property (assign, nonatomic) FontVentureOrderlyStyle defaultStyle UI_APPEARANCE_SELECTOR;

/// Represents the type of mask applied when the HUD is displayed.
/// @discussion Default: FontVentureOrderlyMaskTypeNone.
@property (assign, nonatomic) FontVentureOrderlyMaskType defaultMaskType UI_APPEARANCE_SELECTOR;

/// Defines the animation type used when the HUD is displayed.
/// @discussion Default: FontVentureOrderlyAnimationTypeFlat.
@property (assign, nonatomic) FontVentureOrderlyAnimationType defaultAnimationType UI_APPEARANCE_SELECTOR;
