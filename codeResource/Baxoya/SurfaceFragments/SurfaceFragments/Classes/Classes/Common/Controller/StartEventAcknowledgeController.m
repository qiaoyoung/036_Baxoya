...
//        NSString *title  = item[TabbarTitle];
    ...
    navBar.barTintColor = [UIColor colorWithPatternImage:[StandInteractiveStrategyMusic getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:StandInteractiveStrategyMusicDirectionVertical]];
    [navBar setTitleTextAttributes:dic];
    [navBar setShadowImage:[UIImage new]];
    [navBar setBackgroundImage:[StandInteractiveStrategyMusic getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:StandInteractiveStrategyMusicDirectionLevel] forBarMetrics:UIBarMetricsDefault];
    ...
    if (_configs == nil)
    {
        _configs = @{
                     @(StartEventAcknowledgeTypeMessageList) : @{
                             TabbarVC           : @"OccasionModuleRunTune",
                     ...
                     @(StartEventAcknowledgeTypeChatroomList): @{
                             TabbarVC           : @"IntegrityReadEvaluateDashboardSpot",
                     ...
                     @(StartEventAcknowledgeTypeContact)     : @{
                             TabbarVC           : @"RuggedAnimateResilientRestore",
                     ...
                     @(StartEventAcknowledgeTypeSetting)     : @{
                             TabbarVC           : @"CheckGlobalRoundedMind",
