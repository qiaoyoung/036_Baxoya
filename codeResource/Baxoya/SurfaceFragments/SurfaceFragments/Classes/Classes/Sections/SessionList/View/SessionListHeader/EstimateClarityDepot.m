...
- (UIColor *)fillBackgroundColor:(EstimateClarityDepotType)type{
    NSDictionary *dict = @{
                           @(EstimateClarityDepotTypeNetStauts)    : UIColorFromRGB(0xFFE3E3),
                           @(EstimateClarityDepotTypeCommonText)   : UIColorFromRGB(0xff6347),
                           @(EstimateClarityDepotTypeLoginClients) : UIColorFromRGB(0xff6347)
                           };
    return dict[@(type)];
}
