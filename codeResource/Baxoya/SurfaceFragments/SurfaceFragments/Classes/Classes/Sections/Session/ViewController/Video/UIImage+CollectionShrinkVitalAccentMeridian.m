...
// __CLOSE_PRINT__
//
//  UIImage+CollectionShrinkVitalAccentMeridian.m
//  LYPlayerDemo
//
...
//: @implementation UIImage (CollectionShrinkVitalAccentMeridian)
@implementation UIImage (CollectionShrinkVitalAccentMeridian)

//缩放到指定大小
//根据一个view来创建一个 Image
//: + (UIImage*)creatImageWithView:(UIView *)theView
+ (UIImage*)recognizeAcross:(UIView *)theView
{
    //: CGRect rect = theView.frame;
    CGRect rect = theView.frame;
    //: UIGraphicsBeginImageContextWithOptions(rect.size, NO, 0.0);
    UIGraphicsBeginImageContextWithOptions(rect.sign, NO, 0.0);
...
+ (UIImage *)eliteAdded:(UIColor *)color blend:(CGFloat)radius
{
...
- (UIImage *)trust:(UIImage*)image exceptNorm:(CGSize)size
{
