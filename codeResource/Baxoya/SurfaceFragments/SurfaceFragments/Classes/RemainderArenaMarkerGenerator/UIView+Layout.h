...
@property (nonatomic) CGFloat nextResume;

//: @property (nonatomic) CGFloat left;
@property (nonatomic) CGFloat reduction;
...
@property (nonatomic) CGFloat kick;
...
@property (nonatomic) CGFloat flashThread;
...
@property (nonatomic) CGFloat unity;
...
@property (nonatomic) CGPoint background;
...
@property (nonatomic) CGFloat accurate;
