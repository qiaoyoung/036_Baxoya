...
//: @implementation NSString (RunBonnyJourneyTweak)
@implementation NSString (RunBonnyJourneyTweak)
...
- (NSString *)leaveTruth:(NSString *)table {
    //: NSBundle * languageBundle = [RunBonnyJourneyTweak sharedKit].languageBundle;
    NSBundle * languageBundle = [RunBonnyJourneyTweak fabricWithoutStormDisabled].easy;
    //: return [self nim_localizedByBundle:languageBundle table:table];
    return [self mild:languageBundle whisper:table];
}
...
- (NSString *)mild:(NSBundle *)bundle whisper:(NSString *)table {
    //: if (!bundle) {
    if (!bundle) {
        //: return self;
        return self;
