...
//: @interface AssemblerPureSceneKnown : UIViewController<BeautifyListenCenterVesselOrbit,DisableReliefPreserveFor,AlignOperandAroundCollection,NIMChatManagerDelegate,NIMConversationManagerDelegate,NIMChatExtendManagerDelegate>
@interface AssemblerPureSceneKnown : UIViewController<BeautifyListenCenterVesselOrbit,DisableReliefPreserveFor,AlignOperandAroundCollection,NIMChatManagerDelegate,NIMConversationManagerDelegate,NIMChatExtendManagerDelegate>
...
@property (nonatomic,assign) BOOL drive;//是否通知群消息

//: @property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) UITableView *landAdminThread;
// "canMemberInfo": 1,//0 不允许查看资料 1 是允许
//@property (nonatomic,assign)    BOOL canMemberInfo;
//: @property (nonatomic,assign) BOOL canAddFriend;
@property (nonatomic,assign) BOOL central;
...
@property (nonatomic, strong, readonly) UILabel *pairRest;
/**
 *  当前当初的菜单所关联的消息
 *
...
@property (nonatomic, strong, readonly) NIMMessage *estimatedSensorMember;

//: @property (nonatomic,assign) BOOL canSendText; 
@property (nonatomic,assign) BOOL oceanCenter;// 能够点击语音按钮

//: @property (nonatomic, strong) AbundantOntoRebase *sessionInputView;
@property (nonatomic, strong) AbundantOntoRebase *delayDistinctive;
//: #pragma mark - 操作接口
#pragma mark - 操作接口
...
@property (nonatomic,strong) NIMSession *thread;
...
@property (nonatomic, strong, readonly) UILabel *tense;

//: @property (nonatomic,weak) id<InterruptSpoofBeforeEpisodeReflect> interactor;
@property (nonatomic,weak) id<InterruptSpoofBeforeEpisodeReflect> programFire;
