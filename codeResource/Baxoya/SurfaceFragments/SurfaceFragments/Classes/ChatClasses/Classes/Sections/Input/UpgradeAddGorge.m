...
{
    TextureEntropyDeleteWreath *emoticonCatalog = [[LoopCoolTeamBrainPath sharedManager] emoticonCatalog:NEEKIT_EmojiCatalog];
    if (emoticonCatalog) {
...
{
    TextureEntropyDeleteWreath *emoticonCatalog = [[LoopCoolTeamBrainPath sharedManager] emoticonCatalog:NEEKIT_EmojiGifCatalog];
    if (emoticonCatalog) {
        WaitPrototypeChipTrend *layout = [[WaitPrototypeChipTrend alloc] initEmojiLayout:self.device_width];
        emoticonCatalog.layout = layout;
        emoticonCatalog.pagesCount = [self numberOfPagesWithEmoticon:emoticonCatalog];
