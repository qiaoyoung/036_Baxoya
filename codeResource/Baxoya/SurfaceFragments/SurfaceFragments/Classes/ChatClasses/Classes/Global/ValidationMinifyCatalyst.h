...
#ifndef ValidationMinifyCatalyst_h
#define ValidationMinifyCatalyst_h


#if __has_include(<ShadedPowerMarkAcknowledge/ShadedPowerMarkAcknowledge.h>)
...
#elif __has_include("UIView+PhaseTowerHardy.h")
...
#endif /* ValidationMinifyCatalyst_h */
