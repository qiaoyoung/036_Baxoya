...
//: @implementation ContainerBuoyantMoor
@implementation ContainerBuoyantMoor
//: - (BOOL)shouldIgnoreMessage:(NIMMessage *)message
- (BOOL)shouldIgnoreMessage:(NIMMessage *)message
{
    //: NIMMessageType type = [FilterSereneNotificationGuideTangible sharedConfig].ignoreMessageType;
    NIMMessageType type = [FilterSereneNotificationGuideTangible observe].withFailure;
...
- (BOOL)shouldIgnoreNotification:(NIMNotificationObject *)notification
{
    ...
    {
        //: NSArray *types = [[FilterSereneNotificationGuideTangible sharedConfig] ignoreTeamNotificationTypes];
        NSArray *types = [[FilterSereneNotificationGuideTangible observe] speedAlbum];
