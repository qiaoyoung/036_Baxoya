...
// __CLOSE_PRINT__
//
//  UnregisterDereferenceClipDecorationSpatial.m
...
//: @implementation UnregisterDereferenceClipDecorationSpatial
@implementation UnregisterDereferenceClipDecorationSpatial
...
- (void)drawInContext:(CGContextRef)context {
    ...
    CGContextDrawRadialGradient (context, gradient, self.trend, 0, self.trend, radius, kCGGradientDrawsAfterEndLocation);
